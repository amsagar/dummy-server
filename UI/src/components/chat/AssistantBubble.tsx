...
const DEFAULT_PROSE =
  "prose prose-sm max-w-none prose-slate prose-p:my-1 prose-li:my-0.5 prose-headings:my-2 prose-pre:bg-slate-100 prose-pre:text-xs prose-code:text-xs prose-code:bg-slate-100 prose-code:px-1 prose-code:rounded";
