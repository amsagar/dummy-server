...
public class FrameworkToolPackService {
    ...
    private List<ToolSeed> coreSeeds() {
        return List.of(
                ...
                seed("todowrite", "Update todo list", "workflow", "workflow", false, false, Map.of("todos", "array")),
                ...
                seed("memorycreate", "Create memory file", "memory", "memory", false, false, Map.of("path", "string", "category", "string", "content", "string", "tags", "array")),
    ...
    private List<ToolSeed> experimentalSeeds() {
        return List.of(
                ...
                seed("batch", "Execute batch operations", "workflow", "workflow", true, false, Map.of("tasks", "array")),
                seed("parallel_task", "Run tasks in parallel", "workflow", "workflow", true, false, Map.of("tasks", "array")),
                ...
                seed("pipeline", "Run pipeline steps", "workflow", "workflow", true, false, Map.of("steps", "array")),
