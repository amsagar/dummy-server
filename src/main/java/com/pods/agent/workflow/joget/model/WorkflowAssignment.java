 ...
 * Origin: jw-community/wflow-wfengine/src/main/java/org/joget/workflow/model/WorkflowAssignment.java
...
public class WorkflowAssignment implements Serializable {
    ...
    public String getProcessRequesterId() { return processRequesterId; }
    public void setProcessRequesterId(String processRequesterId) { this.processRequesterId = processRequesterId; }

    public boolean isSubflow() { return subflow; }
    public void setSubflow(boolean subflow) { this.subflow = subflow; }
    ...
    public List<WorkflowVariable> getProcessVariableList() { return processVariableList; }
    public void setProcessVariableList(List<WorkflowVariable> processVariableList) { this.processVariableList = processVariableList; }
    ...
    public double getServiceLevelValue() { return serviceLevelValue; }
    public void setServiceLevelValue(double serviceLevelValue) { this.serviceLevelValue = serviceLevelValue; }
}
